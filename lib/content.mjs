  ...
  const { content, frontmatter } = await compileMDX({
    ...
    options: {
      ...
      mdxOptions: {
        ...
        rehypePlugins: [rehypePrism, rehypeRewriteRelativeUrls(`/microbinfie/${slug}`, 'microbinfie', slug)],
      },
    },
  ...
  try {
    const { content, frontmatter } = await compileMDX({
      ...
      options: {
        ...
        mdxOptions: {
          remarkPlugins: [remarkGfm],
          rehypePlugins: [rehypePrism, rehypeRewriteRelativeUrls(`/posts/${slug}`, 'posts', slug)],
        },
      },
      components: getMDXComponents(),
    })
  ...
  const { content, frontmatter } = await compileMDX({
    ...
    options: {
      ...
      mdxOptions: {
        ...
        rehypePlugins: [rehypePrism, rehypeRewriteRelativeUrls(`/pages`, 'pages', isFolder ? slug : '')],
      },
    },
    components: getMDXComponents(),
  })
