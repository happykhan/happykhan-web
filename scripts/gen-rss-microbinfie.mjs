...
async function main() {
  ...
  for (const p of posts) {
    ...
    try {
      ...
      items.push({
        ...
        link: siteMetadata.url + '/microbinfie/' + p.slug,
        guid: siteMetadata.url + '/microbinfie/' + p.slug,
        pubDate: date,
  ...
  const rss = `<?xml version="1.0" encoding="UTF-8"?>\n<rss version="2.0">\n<channel>\n<title>MicroBinFie - ${siteMetadata.title}</title>\n<link>${siteMetadata.url}/microbinfie</link>\n<description>MicroBinFie podcast episodes and articles about microbial bioinformatics</description>\n${items.map(i => {
