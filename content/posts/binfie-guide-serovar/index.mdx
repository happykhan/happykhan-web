...
When the strain is monophasic, a "-" is used to denote the absence of a second flagellum, as we saw in 1,4,[5],12:i:-. Here are some antigenic formulae for different serovars, which should now feel more friendly. 
