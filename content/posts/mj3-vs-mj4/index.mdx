...
Overall, I am very impressed with the output from version 4. It takes prompts more literally and looks really good. It does not have the surreal dreamlike quality of v3 though. It looks almost boring and mass produced, which it is. If you have suggestions for the prompts, feel free to let me know. 
...
* [promptomania](https://promptomania.com/midjourney-prompt-builder/) - picking phrases for specific prompt. Great for finding styles.
