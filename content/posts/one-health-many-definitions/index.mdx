...
bannerDesc: "an AI generated picture (Midjourney) with prompt; 'one health and antropogenic selection'. You can share and adapt this image following a CC BY-SA 4.0 licence."
tags:
  - Posts
---
...
For example (and my apologies to my comrades in plasmid biology for picking on them), a project using long read sequencing to understand the fundamental mechanics of plasmids and how they mobilise is only tangential to antimicrobial resistance, as plasmids are sometimes a vector for antimicrobial resistance genes. And such a project is certainly not related to One Health as the mechanisms at play are likely much older than modern humans. If we accept the narrow focus presented to us, future projects will be deemed out of scope. The trap with a One Health approach is that it is ultimately anthropocentric, which I have expressed as "the One Health Bechdel test":
...
- [6] Kahn, LH (2006) "[Confronting Zoonoses, Linking Human and Veterinary Medicine](https://doi.org/10.3201/eid1204.050956)". Emerging Infectious Diseases, 12(4), 556-561.
