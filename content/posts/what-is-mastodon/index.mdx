...
If you want to chip in for running costs, you can [Donate using Liberapay](https://liberapay.com/happykhan/donate). You can make a [one-off donation with PayPal](https://www.paypal.com/donate/?hosted_button_id=PT2Z39GS6NMA2).
