...
explicit: 'no'
guests:
- affiliation: Staff Scientist, Johns Hopkins University Center for Computational Biology
  name: Jennifer Lu
  url: null
- affiliation: PhD Student, Biomedical Engineering, Johns Hopkins University
  name: Natalia Rincon
  url: null
