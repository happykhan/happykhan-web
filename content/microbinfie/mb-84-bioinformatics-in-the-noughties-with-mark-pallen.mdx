...
- Sequenced challenging organisms like *Tropheryma whipplei*, which could not be grown in lab traditionally
- Collaborated with David Relman to complete genome sequencing project
- Discovered many previously unknown genes in well-studied organisms like *E. coli*

#### 2. Computational Bioinformatics Innovations
- Utilized iterative tools like CyBLAST for homology searches
- Discovered new insights about sortase systems across multiple bacterial genomes
- Challenged simplistic models of bacterial gene functions

#### 3. Comparative Genomics Approaches
- Explored vestigial gene clusters in *E. coli*
- Identified unexpected distributions of genetic systems across bacterial species
- Emphasized importance of eco-evolutionary context in genome interpretation

### Take-Home Messages
- Bioinformatics tools enable discovery of complex genomic relationships
- Initial genome sequences often represent limited, lab-adapted strains
- Computational approaches can reveal unexpected biological mechanisms
