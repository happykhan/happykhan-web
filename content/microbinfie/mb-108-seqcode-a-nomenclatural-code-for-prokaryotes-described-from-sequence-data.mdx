...
- microbial-taxonomy
- microbial-ecology
title: 'Episode 108: SeqCode: a nomenclatural code for prokaryotes described from sequence data'
transcript: /microbinfie-transcripts/episode-108.txt
---

The microbinfie podcast explores SeqCode, a novel nomenclatural system for naming uncultivated prokaryotes using sequence data, representing a significant advancement in microbial taxonomy.
...
#### 1. SeqCode Origin and Purpose
- Developed to accommodate previously uncultivated microorganisms
- Created as a parallel (not competing) nomenclature code to existing systems
- Aims to democratize the process of naming microbial taxa

#### 2. Governance and Community Approach
- Structured with an executive board, committees, and working groups
- Supported by the International Society for Microbial Ecology (ISME)
- Seeks to be a community-driven initiative with open membership

#### 3. Naming Requirements
- Requires high-quality genome sequences
- Provides multiple validation paths for naming new organisms
- Emphasizes completeness and low contamination in genome data

### Take-Home Messages
- SeqCode represents a collaborative effort to modernize microbial nomenclature
- The system is designed to be inclusive of uncultivated prokaryotes
- Future goal is potential merger with existing nomenclature codes
