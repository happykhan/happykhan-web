...
for article in binfie_rss(rss_feed):
    dir_name = 'content/posts/mb-' + article['safe_name']
    if not path.exists(dir_name):
        mkdir(dir_name)
    index_file = path.join(dir_name, "index.mdx")
